      ...
      <div class="mb-4">
        <Accordion header="Sizes">
          <div class="flex flex-col mt-4 mb-4 bg-orange-50">
            <div class="flex mb-2" v-for="size in product.sizes">
      ...
      <div class="mb-4">
        <Accordion header="Extra Ingredients"
          ><div class="flex flex-col mb-4 mt-4 bg-orange-50">
            <div class="flex mb-2" v-for="size in product.extraIngredients">
              <div class="basis-5/12 ml-2">
                <label
                  class="block text-gray-700 text-sm font-bold mb-2"
                  for="basePrice"
...
const categories = ref(['Pizza', 'Pasta', 'Dessert']);
